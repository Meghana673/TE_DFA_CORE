...
using NToastNotify;
using TE_DFA_CORE.Models;

namespace TE_DFA_CORE.Controllers
{
    public class TraineesController : Controller
    {
        ...
        public TraineesController(ILogger<TraineesController> logger, IToastNotification toastNotification, TE_Core_MVCContext context)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Create([Bind("Tid,Tname,Tage,Tdesignation")] Trainee trainee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Tid,Tname,Tage,Tdesignation")] Trainee trainee)
        {
            if (id != trainee.Tid)
            {
                return NotFound();
